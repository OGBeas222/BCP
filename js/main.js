$(document).ready(function () {
  $(document).on("click", ".search-info__form-item--1", function () {
       $('.search-info__content-1').toggleClass("search-info__content--clicked");
 
  });
  $(document).on("click", ".search-info__form-item--2", function () {
       $('.search-info__content-2').toggleClass("search-info__content--clicked");
